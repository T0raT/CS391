...
function ListItem(props) {
  ...
  return (
    <div className="delay-50 font-family mt-10 flex h-auto w-full max-w-[70%] items-center self-center border-y-[0.1rem] border-zinc-300/80 py-5 text-center font-futura text-white transition ease-in-out hover:-translate-y-1 hover:scale-105">
